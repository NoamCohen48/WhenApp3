...
namespace WhenUp.Controllers
{
    ...
    public class ContactsController : Controller
    {
        ...
        public async Task<User> Index([Bind("Username,Nickname,Password,Avatar")] User user)
        {
        ...
        [Route("{id}")]
        [HttpGet]
        public async Task<User?> Index(string id)
        {
            if (id == null)
            {
                return null;
        ...
        [ValidateAntiForgeryToken]
        [Route("/")]
        public async Task<User?> Index(string id, [Bind("Username,Nickname,Password,Avatar")] User user)
        {
            if (id != user.Username)
            {
                return null;
